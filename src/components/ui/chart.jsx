...
const ChartTooltipContent = React.forwardRef(
   (
      ...
      const formatTooltipValue = (value) => {
         if (value < 1) return value.toPrecision(1); // For small values, use precision
         return value.toLocaleString(undefined, { maximumFractionDigits: 5 }); // For larger values, format with locale string
      };
